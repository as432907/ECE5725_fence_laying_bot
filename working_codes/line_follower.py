...
while motor_running:
    ...
    if (GPIO.input(ENC_CENTER) == GPIO.HIGH):
        ...
        pwm_driver1.ChangeDutyCycle(dc_rev)
        pwm_driver2.ChangeDutyCycle(dc_rev)
        print("dc_clock", dc_rev)
        GPIO.output(AI_1_pin, GPIO.HIGH) # Set AIN1
        GPIO.output(AI_2_pin, GPIO.LOW) # Set AIN2
        GPIO.output(BI_1_pin, GPIO.HIGH) # Set BIN1
        GPIO.output(BI_2_pin, GPIO.LOW) # Set BIN2
        
        if GPIO.input(ENC_LEFT) == GPIO.HIGH and GPIO.input(ENC_RIGHT) == GPIO.LOW: 
        ...
        elif GPIO.input(ENC_RIGHT) == GPIO.HIGH and GPIO.input(ENC_LEFT) == GPIO.LOW:
